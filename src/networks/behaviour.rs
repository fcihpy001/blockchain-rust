use libp2p::{NetworkBehaviour, gossipsub::{Gossipsub, GossipsubConfig, MessageAuthenticity, GossipsubEvent}, mdns::{Mdns, MdnsEvent}, identity::Keypair, swarm::NetworkBehaviourEventProcess, ping};
use anyhow::Result;
...
impl BlockchainBehaviour {
    pub async fn new(
        ...
        msg_sender: UnboundedSender<Messages>
    ) -> Result<Self> {
        Ok(Self {
